...
export class login extends React.Component {
  ...
  async loginSubmit(e) {
    ...
    Object.keys(this.state).forEach(name => {
      ...
      if (
        this.handleRequiredValidation(name, input.value) ||
    ...
    if (!errors) {
      const resp = await api.validateLogin(
          ...
          <div className="rounded shadow pt-5 pb-2 pr-4 pl-4 mt-5 ml-auto mr-auto card col-10 col-sm-8 col-md-7">
            ...
            <form>
              ...
              <div className="form-group">
                <label className="mb-0" htmlFor="input__password">
                  Password
                </label>
                <div className="input-group mb-1">
                  <div className="input-group-prepend">
                ...
                <a
                  className="btn btn nav-link text-left p-0 mb-3 mt-2"
              ...
              <div className="d-flex justify-content-end">
                <button
                  ...
                  className="mr-2 mb-3 btn btn-info"
                >
                  Login
                </button>
              </div>
